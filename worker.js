...
export default { async fetch(request, env) {
  ...
  return responseHeaders.get("content-type")?.includes("text/html") ? new HTMLRewriter().on("[src], [srcset], [href], [poster]", new ResourceElementHandler(incoming)).transform(response) : response;
} };