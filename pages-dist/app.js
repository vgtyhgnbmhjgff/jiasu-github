...
const DEFAULTS = { defaultTarget: "github.com/Cute-Dress/Dress", proxyPath: "/api/proxy", cacheLabel: "1 小时", quickPaths: ["", "/releases", "/archive/refs/heads/main.zip", "/raw/main/README.md"] };
...
form.addEventListener("submit", async (event) => {
  ...
  const proxy = `${proxyEndpoint(window.EDGEDRESS_PROXY_URL)}?url=${encodeURIComponent(target)}`;
